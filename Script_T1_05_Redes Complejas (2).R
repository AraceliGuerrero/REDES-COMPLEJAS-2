...
# Modificado en práctica de laboratorio 11 por L. Araceli Guerrero Herrera (ZuRy)(UAEH) :D
...
# 1. Usar una matriz de datos que contiene el relacionamiento de las exportaciones Hidalguenses.
...
# 2. Estimar el árbol de expansión máxima (MST)
# 3. Graficar
...
M = as.matrix(
  read.csv("C:\\Users\\Araceli Guerrero\\Documents\\Laboratorios de R\\LAB11\\relatednessbinario.csv" , 
           sep = ",", 
           header = T, 
           row.names = 1))
